...
declare module 'varlock/env' {
  ...
  export interface PublicTypedEnvSchema extends Readonly<Pick<CoercedEnvSchema, 'APP_ENV' | 'APP_HOST' | 'APP_PORT' | 'SYSTEM_RESET_PASSWORD' | 'DEV_EMAIL_REDIRECT' | 'APP_URL'>> {}
}
