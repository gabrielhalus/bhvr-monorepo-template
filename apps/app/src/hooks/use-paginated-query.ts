import type { PaginationParams, UsePaginatedQueryOptions, UsePaginatedQueryResult } from "@/query/paginated/types";
...
export function usePaginatedQuery<TData, TError = Error>({
  ...
  // queryFn is a stable prop of this generic wrapper; queryParams already keys the cache.
