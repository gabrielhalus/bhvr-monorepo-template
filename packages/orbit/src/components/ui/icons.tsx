...
/** Official multicolor Google "G" — brand logos are not part of HugeIcons. */
export const Google = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>((props, ref) => (
  <svg ref={ref} viewBox="0 0 24 24" width={24} height={24} aria-hidden="true" {...props}>
