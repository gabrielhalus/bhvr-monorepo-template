...
// ============================================================================
// ChartStyle — inject CSS custom properties for chart colors
// ============================================================================
...
export const ChartTooltipContent = React.forwardRef<
  HTMLDivElement,
  ComponentProps<"div"> &
    Pick<RechartsPrimitive.DefaultTooltipContentProps<any, any>, "payload" | "label" | "labelFormatter" | "labelClassName" | "formatter"> & {
      active?: boolean;
      color?: string;
      hideLabel?: boolean;
  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "border-border/50 bg-background grid min-w-32 items-start gap-1.5 rounded-xl border px-2.5 py-1.5 text-xs shadow-xl",
          className,
        )}
      >
